...
public class DictionaryServletContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            ...
            List<DictionaryEntity> dictionaryEntities = dictionaryService
                    .selectList(new EntityWrapper<DictionaryEntity>());
            ...
            // 捕获所有异常，防止在启动时因数据库或其他问题导致容器启动失败
            logger.error("字典表初始化失败，已跳过字典加载，错误信息：", e);
        }
